-- =====================================================================
-- 01_SCHEMA.SQL
-- Définition du schéma, des index et des triggers de versionnement.
-- =====================================================================

-- ---------------------------------------------------------------------
-- SÉQUENCE GLOBALE DE VERSIONNEMENT
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- TABLE WORKSPACE_MEMBERS (Appartenance et rôles)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- TABLE SETLIST_SONGS (Métier - L'ordre des morceaux dans les setlists)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- TABLE SONG_ASSETS (Métadonnées des audios stockés)
-- ---------------------------------------------------------------------
...
-- Trigger function pour incrémenter server_version et timestamp
...
-- Attachement des triggers aux tables métier
...
-- Trigger automatique pour la création de profil à l'inscription auth.users
...
-- Sécurisation du trigger de profil
