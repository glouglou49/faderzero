...
import type { SetlistSongDetail } from '@/db/schema';
...
export function SetlistDetailPage() {
  ...
  function buildTransitionLine(entry: SetlistSongDetail) {
    ...
    if (entry.noteShowBpm && entry.songBpm) {
      parts.push(`${entry.songBpm} BPM`);
    }
    if (entry.noteShowKey && entry.songKey) {
      parts.push(entry.songKey);
    }
    if (annotation) {
  ...
  return (
    <div className="space-y-5 pb-6">
      <section
        className="sticky z-30 -mx-1 border-b border-white/8 bg-[var(--fz-bg)] px-1 pb-4 pt-2"
          ...
          <div className="flex items-center justify-end gap-2">
            {isEditing ? (
              <button
                ...
                className="flex h-11 w-11 items-center justify-center rounded-[1rem] border border-rose-500/20 bg-rose-500/10 text-rose-300 disabled:opacity-60"
              >
            ...
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-[1rem] border border-emerald-500/20 bg-emerald-500/10 text-emerald-300"
            >
            ...
            <form className="space-y-3" onSubmit={handleSaveSetlist}>
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  rows={4}
                  disabled={isSaving}
                  className="fz-input min-h-32 resize-y text-sm"
                />
              </label>
              <button
                type="submit"
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={[
                    'rounded-[1rem] border px-4 py-3 text-sm font-black transition',
                    transitionShowBpm
            ...
            <div className="rounded-[1rem] border border-white/8 bg-black/20 px-4 py-3">
              ...
              <p className="mt-2 text-sm italic text-white/78">
                {(function () {
                  ...
                  if (transitionShowBpm && editingTransitionEntry.songBpm) {
                    previewParts.push(`${editingTransitionEntry.songBpm} BPM`);
                  }
                  if (transitionShowKey && editingTransitionEntry.songKey) {
                    previewParts.push(editingTransitionEntry.songKey);
                  }
